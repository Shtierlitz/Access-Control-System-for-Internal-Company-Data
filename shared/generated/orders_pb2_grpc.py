...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListOrdersByUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=orders__pb2.UserIdRequest.FromString,
...
class OrderService(object):
    ...
    def ListOrdersByUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/ListOrdersByUser',
            orders__pb2.UserIdRequest.SerializeToString,
